...
def wishMe():
    ...
    speak("I am firday. Online and ready sir. Please tell me how may I help you")
    ...
    def TaskExecution(self):
        ...
        # if 1:
            ...
            if 'tell me about' in self.query:
                ...
                playsound('mylivewallpapers.com-Iron-Man-Nano-Tech.mp3')
                Path = "C:\\Users\\Godwin Tony\\Downloads"
                os.startfile(Path)
                speak('i am on.. ')
                ...
                webbrowser.open("search google for")
